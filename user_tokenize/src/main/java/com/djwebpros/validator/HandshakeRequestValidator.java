...
/**
 * class to validate Handshake Request.
 * @author DJ
 */
public class HandshakeRequestValidator extends RequestValidator {
	...
	public void validate(JSONObject errorJson, JSONObject postJSONData) throws JSONException {
		...
		String validationFlow = validtionFlowProperty.getProperty("validationFlow.Handshake");
