...
/**
 * class to validate ReHandshake Request.
 * @author DJ
 */
public class ReHandshakeRequestValidator extends RequestValidator {
	...
	public void validate(JSONObject errorJson, JSONObject postJSONData) throws JSONException {
		...
		String validationFlow = validtionFlowProperty.getProperty("validationFlow.ReHandshake");
